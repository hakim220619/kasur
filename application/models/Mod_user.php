...
class Mod_user extends CI_Model
{
    ...
    function cekmerekkasur($merek_kasur)
    {
        $this->db->where("merek_kasur", $merek_kasur);
        return $this->db->get("kategori_kasur");
    }
    function cektempat($id_industri)
    {
        $this->db->where("id_industri", $id_industri);
        return $this->db->get("tempat_industri");
    }


    function getImagekategori($id)
    {
        $this->db->select('gambar');
        $this->db->from('kategori_kasur');
        $this->db->where('id_kasur', $id);
        return $this->db->get();
    }

    function getImagetempatindustri($id)
    {
        $this->db->select('gambar_lokasi');
